...
var channelstrn="vladimir.softomantica.com";
var pagetitle="Вечер памяти, посвященный 79-ой годовщине со дня рождения Владимира Высоцкого";
var hopbase="https://s3.amazonaws.com/rpool.strn/";
var hopch="http://vladimir.softomantica.com";
...
"autostart": true,
    "playlist": plist,
'provider': 'rtmp', 
'streamer': 'rtmp://svybdjjtz9i7w.cloudfront.net/cfx/st/', 
 'modes': [
    {   
        type: 'flash',
        src: '' 
...
return false;
 ...
 $http.get($scope.querygetstrn).then(function (response) {
  $scope.ChTitle="Maple Leafs LTO Video";
