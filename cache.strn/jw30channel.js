...
v="";
for(var i=0;i<files.length;i++){
v=v+"<tr><td><input type=checkbox value='1' name='keep' checked id='keep"+i+"' title='check to keep item in session' ></td><td>"+(i+1)+"</td><td>"+plink[i].link+"</td><td>"+pclone[i].link+"</td></tr>";
};

dlhtml="<table><th>Session</th><th></th><th>Download</th><th>Clone</th>"+v+"</table>";
